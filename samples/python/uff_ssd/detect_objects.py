...
def analyze_prediction(detection_out, pred_start_idx, img_pil):
    ...
    if confidence > VISUALIZATION_THRESHOLD:
        ...
        print(
            "Detected {} with confidence {}".format(class_name, confidence_percentage)
        )
...
def parse_commandline_arguments():
    ...
    args.trt_engine_path = PATHS.get_engine_path(
        args.trt_engine_datatype, args.max_batch_size
    )
    try:
...
def main():
    ...
    print(
        "Total time taken for one image: {} ms\n".format(
