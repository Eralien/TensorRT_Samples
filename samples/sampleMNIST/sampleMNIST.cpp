...
//!
//! It builds a TensorRT engine by importing a trained MNIST Caffe model. It
//! uses the engine to run
//! inference on an input image of a digit.
//! It can be run with the following command line:
//! Command: ./sample_mnist [-h or --help] [-d=/path/to/data/dir or
...
class SampleMNIST {
 ...
 private:
  ...
  SampleUniquePtr<nvcaffeparser1::IBinaryProtoBlob> mMeanBlob;  //! the mean
                                                                //! blob, which
                                                                //! we need to
                                                                //! keep around
                                                                //! until build
...
void SampleMNIST::constructNetwork(
  ...
  // After the mean subtraction occurs, the range is expected to be between -127
  // and 127, so the rest of the network
...
//!
void printHelpInfo() {
  std::cout << "Usage: ./sample_mnist [-h or --help] [-d or --datadir=<path to "
