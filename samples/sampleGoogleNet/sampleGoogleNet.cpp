...
//!
//! sampleGoogleNet.cpp
//! This file contains the implementation of the GoogleNet sample. It creates
//! the network using
//! the GoogleNet caffe model.
//! It can be run with the following command line:
//! Command: ./sample_googlenet [-h or --help] [-d=/path/to/data/dir or
...
//! engine
//!
//! \details This function creates the GoogleNet network by parsing the caffe
//! model and builds
...
//!
void printHelpInfo() {
  std::cout << "Usage: ./sample_googlenet [-h or --help] [-d or "
...
int main(int argc, char** argv) {
  ...
  gLogInfo << "Building and running a GPU inference engine for GoogleNet"
           << std::endl;
